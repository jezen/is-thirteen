...
tap.equal(is("thập tam").thirteen(), true); // Sino-Vietnamese
tap.equal(is("mườiba").thirteen(), true); // Vietnamese without space
tap.equal(is("thậptam").thirteen(), true); // Sino-Vietnamese without space
