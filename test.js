...
tap.equal(is('Al').thirteen(), true);
tap.equal(is('Aluminium').thirteen(), true);
tap.equal(is('Boron').thirteen(), true);
tap.equal(is('B').thirteen(), true);
tap.equal(is('Gallium').thirteen(), true);
tap.equal(is('Ga').thirteen(), true);
tap.equal(is('Indium').thirteen(), true);
tap.equal(is('In').thirteen(), true);
tap.equal(is('Thallium').thirteen(), true);
tap.equal(is('Tl').thirteen(), true);
tap.equal(is('Ununtrium').thirteen(), true);
tap.equal(is('Uut').thirteen(), true);
