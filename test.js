...
tap.equal(is("ܬܠܬܥܣܪ").thirteen(), true); // Aramaic (Syriac script without vowel marks)
tap.equal(is("𐡋𐡊").thirteen(), true); // Aramaic (Imperial Aramaic numerals)
tap.equal(is("תְּלַתְעֶסְרֵה").thirteen(), true); // Aramaic (Hebrew square script - feminine)
tap.equal(is("תְּלַתְעֶסְרֵי").thirteen(), true); // Aramaic (Hebrew square script - masculine)
tap.equal(is("תלתעשרה").thirteen(), true); // Aramaic (Hebrew square script - feminine, without space)
tap.equal(is("תלתעשרי").thirteen(), true); // Aramaic (Hebrew square script - masculine, without space)
tap.equal(is("תְּלַת- עֶשְרֵה").thirteen(), true); // Aramaic (Hebrew square script - feminine, with punctuation)
tap.equal(is("תְּלַת- עֶשְרֵי").thirteen(), true); // Aramaic (Hebrew square script - masculine, with punctuation)
tap.equal(is("תלת עשר").thirteen(), true); // Aramaic (Hebrew square script - variant)
tap.equal(is("תלתה עשר").thirteen(), true); // Aramaic (Hebrew square script - variant)
tap.equal(is("trelthasar").thirteen(), true); // Aramaic (transliteration)
tap.equal(is("telath'esre").thirteen(), true); // Aramaic (feminine transliteration)
tap.equal(is("telath'esrei").thirteen(), true); // Aramaic (masculine transliteration)
tap.equal(is("tlāṯʿesrē").thirteen(), true); // Aramaic (feminine transliteration - alternative)
tap.equal(is("tlāṯʿesrēy").thirteen(), true); // Aramaic (masculine transliteration - alternative)
tap.equal(is("tlat esre").thirteen(), true); // Aramaic (simplified transliteration - feminine)
tap.equal(is("tlat esrei").thirteen(), true); // Aramaic (simplified transliteration - masculine)
tap.equal(is("trellathasar").thirteen(), true); // Aramaic (variant transliteration)
