...
tap.equal(is("Luiz Inácio Lula da Silva").thirteen(), true); // Because the brazilian president Luiz Inácio Lula da Silva is always 13, amigo
tap.equal(is("Lula").thirteen(), true); // Because the brazilian president Luiz Inácio Lula da Silva is always 13, amigo
